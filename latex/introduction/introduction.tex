...
\section{Objectives}
\vspace{-0.1cm}
As part of this research study, will be outline the main principles of Causal Reasoning and different application approaches (e.g. Knowledge Graphs, Bayesian Belief Networks, Explainable AI) and case studies (e.g. Epidemic Modelling). 