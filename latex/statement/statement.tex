...
\begin{tcolorbox}
During the course of this project I followed different online tutorials and courses. All of them have been have been acknowledged in the body of the report and referenced in the bibliography (such as: \cite{ppc}, \cite{why}, \cite{physics}, \cite{tds}, \cite{immune}). Any minor additional source used, has been acknowledged in the code files available in the Project Design Archive as a comment. 
\end{tcolorbox}
