\documentclass[a4paper,12pt,twoside]{memoir} %memoir, report (switch to update)
%\usepackage[left=2cm,right=2cm,top=2cm,bottom=3cm]{geometry}
\usepackage{hyperref}
\usepackage{graphicx} % including images
\graphicspath{ {./images/} } % images file path
\usepackage{subfig}
\usepackage{amssymb}
\usepackage{epigraph}
\usepackage{listings}
...
\cleardoublepage
\thispagestyle{empty}
\input{acknowledgements/quote.tex}
\preface
...
\input{technicalprogress/technicalprogress}
\input{AI/AI}
\input{management/management.tex}
\input{planwork/planwork.tex}
